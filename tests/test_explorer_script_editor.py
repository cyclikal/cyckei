...
def test_make_script():
    ...
    f1.close()
    f2.close()
    test_script1 = script_editor.Script("C:/Users/Cyclikal/repos/cyckei/tests", "test_file1.txt")
    test_script2 = script_editor.Script("C:/Users/Cyclikal/repos/cyckei/tests", "test_file2.txt")
    # Testing the variables that are initialized by calling the constructor.
    assert test_script1.path == "C:/Users/Cyclikal/repos/cyckei/tests"
    assert test_script1.title == "test_file1.txt"
    assert test_script1.content == ""
    assert test_script2.path == "C:/Users/Cyclikal/repos/cyckei/tests"
...
def test_save_script():
    ...
    f1.close()
    f1 = open("tests/test_file1.txt", "r")
    match = f1.read()
    f1.close()
    test_script1 = script_editor.Script("C:/Users/Cyclikal/repos/cyckei/tests", "test_file1.txt")
...
def test_status_script():
    ...
    assert os.path.isfile("C:/Users/Cyclikal/repos/cyckei/tests/test_file1.txt") == True
    assert os.path.isfile("C:/Users/Cyclikal/repos/cyckei/tests/* test_file1.txt") == False
    # cleaning up files created for testing
    os.remove("tests/test_file1.txt")
...
def test_make_scriptlist():
    ...
    if os.path.isdir("C:/Users/Cyclikal/repos/cyckei/tests/scripts") == False:
        os.mkdir("C:/Users/Cyclikal/repos/cyckei/tests/scripts")
    ...
    os.rmdir("C:/Users/Cyclikal/repos/cyckei/tests/scripts")
...
def test_by_title_scriptlist():
    ...
    f2_script_name_dupe = script_editor.Script("C:/Users/Cyclikal/repos/cyckei/tests/scripts", "test_file2.txt")
