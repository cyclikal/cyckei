...
class ChannelWidget(QWidget):
    ...
    def __init__(self, channel, server, record_folder):
        ...
        rows.addWidget(self.elements[15])
        ...
        # Load default JSON
        self.json = json.load(open("client/defaultJSON.json"))
    ...
    def check(self):
        ...
        package = json.load(open("client/defaultJSON.json"))
