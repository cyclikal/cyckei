...
Workflow
--------
`GitLab`_ hosts and manages version control for the Cyckei source code. The Cyckei project is kept under Cyclikal LLC's `repository`_.
To submit patches to the codebase, fork the project to a personal `GitLab`_ account and make any desired changes.
